...
in 2003. To determine orientation, we'll track two locations on the
fish, and calculate the horizontal distance between them. If this
distance falls between an acceptable range, we can conclude that the
fish is facing to the left.
